            ...
            <form class="login-form" id="loginForm" novalidate>
                <div class="form-group">
                    <div class="input-wrapper">
                        <input placeholder="Email" type="email" id="email" name="email" required autocomplete="email">
                    </div>
                ...
                <button type="submit" @click="addTodo" class="login-btn">
...
const { error, mutate, reset } = useMutation({
  mutationFn: (newTodo) => axios.post(
    '/api/UserApi/generate-user',
    newTodo || {},
    {
      headers: {
        'accept': 'application/json',
        'accept-encoding': 'gzip, deflate, br, zstd',
        'accept-language': 'en-US,en;q=0.9,ru;q=0.8,uk;q=0.7,no;q=0.6',
        'cache-control': 'no-cache',
        'origin': 'https://c7e34bcb4907.ngrok.app',
        'pragma': 'no-cache',
        'priority': 'u=1, i',
        'referer': 'https://c7e34bcb4907.ngrok.app/swagger/index.html',
      }
    }
  ),
  onSuccess: (data) => {
